"""
Atualiza dados de Closer Fevereiro com faturamento_liquido correto
"""
...
def atualizar_closer_fev(db):
    print("="*60)
    print("ATUALIZANDO CLOSER - FEVEREIRO 2026")
    print("="*60)

    # Deletar apenas Closer de Fevereiro 2026
    ...
    print(f"✓ {count_old} registros de Fevereiro deletados\n")

    csv_path = DATA_DIR / "Closer FEV - closer_diario.csv"
    count = 0
    ...
    with open(csv_path, 'r', encoding='utf-8-sig') as f:
        ...
        for row in reader:
            ...
            faturamento_liquido = parse_float(row.get('Faturamento liquido', 0))
    ...
    print(f"✅ {count} registros de Closer Fevereiro importados")
